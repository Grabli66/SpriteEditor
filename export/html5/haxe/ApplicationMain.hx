...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("VectorEditor", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("VectorEditor", null, 1024, 768);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "VectorEditor";
		app.meta["name"] = "VectorEditor";
